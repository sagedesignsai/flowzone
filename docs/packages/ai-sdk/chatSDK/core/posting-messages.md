...
For multi-turn conversations, use `toAiMessages()` to convert thread history into the `{ role, content }[]` format expected by AI SDKs.
...
**Source:** https://chat-sdk.dev/docs/posting-messages
