...
| `values` | `Record` | Form field values keyed by input `id` |
...
| `relatedChannel` | `Channel` (optional) | Channel where the modal was triggered |
...
**Source:** https://chat-sdk.dev/docs/modals
